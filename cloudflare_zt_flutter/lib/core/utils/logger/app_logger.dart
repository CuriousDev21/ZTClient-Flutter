...
final class LoggerLogging extends Logger {
  final _logger = logging.Logger('SinaAppLogger');
  ...
  L runLogging<L>(L Function() fn, [LogOptions options = const LogOptions()]) {
    ...
    _logger.onRecord.where((event) => event.loggerName == 'SinaAppLogger').listen((event) {
